...
public class DetailsAltController {
    ...
    @GetMapping("/sefaz")
    public String detalheSefaz(Authentication authentication, @RequestParam("cnpjEmpresa") String cnpjEmpresa, @RequestParam("idAlt") Long idNota, @RequestParam("mes") String mes, Model model) {
